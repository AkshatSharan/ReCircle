...
export const getAllItems = (currentUserUid) => axiosInstance.get(`/items?excludeUser=${currentUserUid}`);
...
export const getUserNotifications = (uid) => axiosInstance.get(`/users/${uid}/notifications`);

export const markNotificationsAsRead = (uid) => axiosInstance.put(`/users/${uid}/notifications/read`);